...
If you look through the older posts, you will find someone who was very close to the craft all the time: building things, experimenting, thinking about tools, writing about side projects, and occasionally getting obsessed with old computers or some tiny technical detail that felt too interesting to ignore. That person is still here.

But I am not only that person anymore.

These days, I spend most of my working life helping teams build products across app and web. My title says engineering director, and that is accurate enough, but it does not capture how I think about the work. I still think of myself as a maker first and a leader second.
...
Still, I have never stopped feeling that urge to make things.

I still like the moment where an idea moves from vague to concrete. I still like sketching something out, testing a thought in code, writing a rough draft, or following curiosity just far enough to see if there is something real there. Even when my role pulls me toward alignment, planning, and coordination, some part of me is always looking for the smallest useful thing that can be built next.

That tension is probably a big part of who I am now.

On one side, I care deeply about organizations, teams, and how good product work happens in practice. I care about how decisions get made, how strategy becomes execution, and how to create an environment where engineers can do thoughtful, sustainable work. On the other side, I still care about the tools, the experiments, the prototypes, and the occasional side quest that exists mostly because making things is fun.
...
So this blog probably needs to reflect that more clearly than it has in the past.
...
I just happen to spend a lot more of my time leading too.
